<template>
<div class="mt-5">
<div v-for="notification in notification" :key="notification">
    <div class="row">
      <div class="col-xs-12 col-sm-10 col-sm-offset-3">
        <div class="new-message-box">
          <div class="new-message-box-success">
            ...
            Vous avez une seance du module : <strong>{{notification.module.module}}</strong>
            pour le {{notification.seance.jour}} de {{notification.seance.heure}}
            dans la salle {{notification.salle.numero}}
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    async created() {
      await axios
        .get('http://127.0.0.1:8000/api/notificationetudiant', {
          params: {
...
@media only screen and (max-width : 979 px) {
